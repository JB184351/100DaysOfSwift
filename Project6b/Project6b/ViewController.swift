...
//  Project6b
//
//  Created by Justin Bengtson on 8/12/19.
...
//            label.widthAnchor.constraint(equalTo: view.widthAnchor).isActive = true
            ...
            //label.heightAnchor.constraint(equalTo: view.viewSafeAreaLayoutGuide.heightAnchor, multiplier: (1/5), constant: -10).isActive = true
